...
const { registerUser, loginUser, current, validateUser, logoutUser,
    addIncome, fetchIncomes, updateIncome, deleteIncome,
    addMethod, getMethods, deleteMethod,
    fetchIncomeTimePeriod, fetchSpendsTimePeriod } = require('../controllers/user');
...
router.get("/income/:fromDate/:toDate", validateToken, fetchIncomeTimePeriod);

router.get("/spends/:fromDate/:toDate", validateToken, fetchSpendsTimePeriod);
